...
| **Phillip Burton — AB-410 exam prep (Udemy)** — *enrolled 2026-09-21* | The AB-410 lab track: builds an Expenses solution end to end (Dataverse → model-driven app → logic → flows → canvas → AI Hub). Only 8 h of the 21 h is AB-410; the rest is a bolted-on PL-200 course. | Paid, owned | Updated 2026-09-21. **Warwick cut:** 2 h listen / 5½ h do-along; AI Hub depth is the weak spot — `udemy-ab410-burton-analysis.md`. |
...
| **DX Labs Global — AB-620 Masterclass (YouTube, free)** | AB-620 Area 2 visual orientation: multi-agent, child/connected agents, A2A, MCP, knowledge/Azure AI Search | Free video | 61 videos / 7h06m. **Selective supplement**, orientation only — use the ~2h46m LISTEN/USE cut; no Area 3 (testing/ALM), no computer use/HIL/monitoring; accuracy unverified (`dxlabs-ab620-playlist-audit.md`). |
