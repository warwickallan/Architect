...
The Udemy set was taken from the enrolled course's own caption files (English / English [Auto]) via the logged-in course player on 2026-09-19 — not YouTube, so `fetch_transcripts.py` doesn't apply; the manifest entry records it. Committed at Warwick's decision (2026-09-19).
