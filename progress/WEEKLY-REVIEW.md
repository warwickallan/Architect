...
**Warwick did personally:** ruled on repo topology and the method exemption, over Claude's contrary argument. Ruled on Ask AI availability during assessment (locked until submission, over always-on and absent). Rejected the first project model and specified the correct nesting. Used the LMS and reported four defects from doing so — no exit from a session, a dead player, dead View buttons, incoherent hierarchy.
