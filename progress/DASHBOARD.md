...
|---|---|---|---|---|---|---|---|
| CPMAI | 6 (provisional — phase-level, unverified) | 6 | 0 | 0 | 0 | 0 | 0 |
...
|---|---|---|---|
| CPMAI | ≈ Nov–Dec 2026 | Official outline not yet obtained (A12) | No |
| AB-620 | ≈ Dec 2026 | — | No |
...
`ASSUMPTIONS.md` A03 (licences/environments), A12 (CPMAI outline), A13 (reviewers unnamed).
